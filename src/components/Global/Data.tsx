...
const projects = [
  ...
  },
  {
    ...
    description: (
      <p style={{ marginBottom: 0 }}>
        Hosted 2020 COVID-19 Hackathon I and II with 600+ global participants to address post-COVID
        life. Received media recognition from{' '}
        <a
          className="link"
...
const about = [
  ...
  },
  {
    ...
    component: (
      <p className="section" style={{ whiteSpace: 'pre-wrap' }}>
        GitHub:{'  '}
        <a target="_blank" rel="noreferrer" className="link" href="https://github.com/haydendaly">
          haydendaly
        </a>
        <br />
        LinkedIn:{'  '}
