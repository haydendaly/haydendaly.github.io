...
const projects = [
  ...
  },
  {
    ...
    category: ["Web", "Design"],
    text:
      "Starting nonprofit for local environmental focused tech initiatives.\n",
    description:
  ...
  },
  {
    ...
    text: "Built distributed trade-space simulations under NASA contract.\n",
    description:
  ...
  },
  {
    ...
    category: ["Mobile", "Design"],
    text: "Built an app for university-oriented group chats.\n",
    description:
  ...
  },
  {
    ...
    text: "Created an AI-concierge app startup. \n",
    description:
  ...
  },
  {
    ...
    text: "Led a team to build full-stack mobile book club app. \n",
    description:
    ...
    component: (
      <p className="section" style={{ whiteSpace: "pre-wrap" }}>
        {`I'm a currently a full-time Connective Media masters student at Cornell Tech in NYC. Before this, I did a bachelors in Software Engineering at Stevens Institute in Hoboken, NJ. Most of my free time I spend either running, reading, cooking, or coding. I compete on the varsity cross country and track teams at my university and plan to pursue ultra running after graduation.
            I'm also involved in some side projects—some are:  `}
        ...
        <Link className="link" to={"/projects/testbed"}>
          infrastructure, protocol, and operator system
        </Link>
    ...
    component: (
      <p>
        ...
        <a
          className="link"
          target="_blank"
          href="https://www.goodreads.com/book/show/21480734-dataclysm"
        >
          <i>Dataclysm by Christian Rudder</i>
        </a>
        <br />
        <a
          className="link"
